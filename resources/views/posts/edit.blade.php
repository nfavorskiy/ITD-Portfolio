...
<div class="container mt-5">
    ...
    <form method="POST" action="{{ route('posts.update', $post) }}" id="edit-post-form">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="title" id="title" value="{{ old('title', $post->title) }}" class="form-control @error('title') is-invalid @enderror" required>
            @error('title')
        ...
        <button type="submit" class="btn btn-primary" id="submit-btn">Update Post</button>
